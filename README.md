...
Change the default metadata in `package.json` to reflect your project, remove the `.sample` extensions from the `.env.*` environment files, and optionally add a `README.md`
